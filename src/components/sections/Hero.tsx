...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex items-end overflow-hidden">
      ...
      {/* Rich multi-layer overlay — deep and warm, not flat tech-black */}
      <div className="absolute inset-0 bg-gradient-to-t from-[#0c0907] via-[#0c0907]/80 to-[#0c0907]/30" />
      <div className="absolute inset-0 bg-gradient-to-r from-[#0c0907]/70 via-transparent to-transparent" />
      ...
      {/* Content — positioned at bottom for cinematic feel like law-hub */}
      <div className="relative z-10 w-full max-w-7xl mx-auto px-8 lg:px-14 pb-24 pt-48">

        {/* Eyebrow — small caps, Lora italic */}
        <motion.p
        ...
        {/* Main headline — Cormorant Garamond, very large */}
        <motion.h1
        ...
        {/* Subtitle — Lora, warm and readable */}
        <motion.p
        ...
        >
          ...
          <a
            ...
            onMouseEnter={(e) =>
              (e.currentTarget.style.backgroundColor = "#9c1820")
            }
            onMouseLeave={(e) =>
              (e.currentTarget.style.backgroundColor = "#c41e28")
            }
          >
            {t("cta_primary")}
            <ArrowRight
        ...
        {/* Practice areas strip — like law-hub's bottom info bar */}
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          {["Derecho Corporativo", "Derecho Migratorio", "Derecho Inmobiliario"].map(
            (area, i) => (
              <span
                key={area}
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(to top, #0c0907 0%, transparent 100%)",
        }}
      />
    </section>
  );
